...
class ProductItemAuMall extends StatefulWidget {
  ...
  ProductItemAuMall({super.key, required this.productFavoriteEntity, this.isAuctionProduct});
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            widget.isAuctionProduct! ? Container() :Positioned(
                  ...
                  children: [
                    ...
                    Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(
                            text: '${double.parse(widget.productFavoriteEntity.price!).toInt()} đ',
                    ...
                    const SizedBox(height: 6.0),
                    widget.isAuctionProduct! ? InkWell(
                      child: Container(
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => ProductDetails(
                                productSimpleEntity: widget.productFavoriteEntity,
                                index: 1,
                                isFromAuction: widget.isAuctionProduct! ? true : false,
                              ),
                            ));
                      },
                    ): Container()
