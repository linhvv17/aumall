...
class AddAuctionProductUseCase
    extends BaseUsecase<bool, AddAuctionProductUseCaseParams> {
  final AuctionBaseRepository auctionBaseRepository;
  AddAuctionProductUseCase(this.auctionBaseRepository);

  @override
  Future<Either<Failure, bool>> call(
      AddAuctionProductUseCaseParams params) async {
    final response =
        await auctionBaseRepository.addAuctionProduct(params.idProduct);
    return response;
  }
}
