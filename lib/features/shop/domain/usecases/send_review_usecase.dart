...
class SendReviewUseCase
    extends BaseUsecase<ResponseEntity, SendReviewUseCaseParams> {
  final ProductRepository productRepository;

  SendReviewUseCase(this.productRepository);
  @override
  Future<Either<Failure, ResponseEntity>> call(
      SendReviewUseCaseParams params) async {
    return await productRepository.sendReview(
        SendReviewParams(params.productId, params.comment, params.rating));
  }
}
