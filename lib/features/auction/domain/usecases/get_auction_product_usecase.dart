...
class GetAuctionProductUseCase extends BaseUsecase<ListAuctionEntity, GetAuctionParams>{
  final AuctionBaseRepository auctionBaseRepository;
  GetAuctionProductUseCase(this.auctionBaseRepository);

  @override
  Future<Either<Failure, ListAuctionEntity>> call(GetAuctionParams params) async {
