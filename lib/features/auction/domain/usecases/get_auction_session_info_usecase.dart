...
class GetAuctionSessionInfoUseCase extends BaseUsecase<AuctionSessionInfoEntity, GetAuctionSessionInfoParams>{
  final AuctionBaseRepository auctionBaseRepository;
  GetAuctionSessionInfoUseCase(this.auctionBaseRepository);

  @override
  Future<Either<Failure, AuctionSessionInfoEntity>> call(GetAuctionSessionInfoParams params) async {
